...
Plans:
- [ ] 13-01-PLAN.md — DB schema (pages JSONB), migration, PATCH API + generate API update, public routing, relative link instruction
...
| 13. Multi-page Website Support | v1.2 | 0/2 | Planned | - |
