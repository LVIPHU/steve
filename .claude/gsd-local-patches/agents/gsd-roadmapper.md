...
Reference full template: `D:/STEVE/steve/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/STEVE/steve/.claude/get-shit-done/templates/state.md`.
