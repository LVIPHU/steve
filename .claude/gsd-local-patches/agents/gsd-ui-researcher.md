...
Use template from `D:/STEVE/steve/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/STEVE/steve/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/STEVE/steve/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
